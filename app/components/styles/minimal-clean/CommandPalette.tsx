/**
 * CommandPalette Component - Minimal Clean Style
 *
 * A power-user command interface with Swiss restraint. Precise typography,
 * monospace shortcuts, subtle selection states. Fast, confident transitions.
 */
          ...
          >
            {group.items.map((item) => (
              <Command.Item
                ...
                "
              >
                {/* Optional icon - subtle */}
                {item.icon && (
                  <span className="text-gray-500 [&>svg]:w-4 [&>svg]:h-4">
                    {item.icon}
                  </span>
                )}
                ...
                {/* Keyboard shortcut - monospace, contained */}
                {item.shortcut && (
                  <kbd className="
                    px-1.5 py-0.5
                    text-xs font-mono
...
export function CommandPalette({
  ...
  return (
    ...
    >
      ...
      {/* Dialog content - positioned high, generous width */}
      <div className="
