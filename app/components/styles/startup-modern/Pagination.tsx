/**
 * Pagination Harness - Startup Modern Style
 *
 * Clean pagination with yellow-600 active state.
 * Rounded corners, subtle borders, quick transitions.
 */
...
/**
 * Pagination component with startup-modern styling.
 * Yellow-600 active state, clean rounded buttons.
 */
export function Pagination({
  ...
  const buttonBaseClass =
    "inline-flex items-center justify-center min-w-[2.5rem] h-10 px-3 text-sm font-medium border rounded-md transition-all duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-600 focus-visible:ring-offset-2";
