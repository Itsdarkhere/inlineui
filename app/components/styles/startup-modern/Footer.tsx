/**
 * Footer - Startup Modern Style
 *
 * Clean, organized footer with subtle gray background.
 * Yellow-600 hover states for social icons.
...
/**
 * Footer - Multi-column footer section with startup-modern styling
 */
              ...
              <div className="flex gap-4 mt-6">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="text-gray-500 hover:text-yellow-600 transition-colors duration-150"
                  >
                    {social.icon}
                  </a>
                ))}
