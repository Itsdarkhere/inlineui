/**
 * Alert - Corporate Classic Style
 *
 * Professional notification messages with muted semantic colors.
 * Left border accent, clean typography, dismissible option.
 */
...
/**
 * Corporate Classic Alert component.
 * Professional styling with left border accent and muted semantic colors.
 */
export function Alert({
  ...
  // Variant-based classes - professional, muted colors with left border
