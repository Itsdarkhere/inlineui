/**
 * CommandPalette - Corporate Classic Style
 *
 * Professional command palette with clean borders and subtle shadows.
 * Yellow-600 selection highlighting, gray keyboard shortcuts.
 */
    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-4 border-b border-gray-200">
        ...
        <Command.Input
          ...
          className={`w-full py-3.5 text-sm bg-transparent border-0 outline-none placeholder:text-gray-400 ${inputClassName}`}
        />
      </div>
          ...
          >
            {group.items.map((item) => (
              <Command.Item
                ...
                className="flex items-center gap-2.5 px-2 py-2.5 text-sm text-gray-700 rounded cursor-pointer aria-selected:bg-yellow-50 aria-selected:text-gray-900 aria-disabled:opacity-50 aria-disabled:cursor-not-allowed transition-colors"
              >
                {/* Optional icon */}
                {item.icon && (
