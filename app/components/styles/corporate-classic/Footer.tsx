/**
 * Footer - Corporate Classic Style
 *
 * Professional multi-column footer with subtle gray background.
 * Uppercase section titles, gray-900 logo, yellow-600 social hover.
 */
...
/**
 * Corporate Classic Footer component.
 * Professional styling with uppercase titles and gray background.
 */
export function Footer({
  ...
  return (
    <footer
      className={`bg-gray-100 border-t border-gray-200 ${className}`}
    >
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4">
            ...
            {tagline && (
              <p className="mt-4 text-sm text-gray-600 max-w-xs leading-relaxed">{tagline}</p>
            )}
              ...
              <div className="flex gap-4 mt-6">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="text-gray-500 hover:text-yellow-700 transition-colors duration-150"
                  >
                    {social.icon}
                  </a>
                ))}
