/**
 * Toast - Corporate Classic Style
 *
 * Professional notification toasts with subtle semantic colors.
 * Clean borders, yellow-600 action styling, professional animations.
 */
...
/** Get variant-specific styles - professional, muted colors */
  ...
  return (
    ...
    >
      ...
      {action && (
        <ToastPrimitive.Action altText={action.label} asChild>
          <button
            ...
            className="flex-shrink-0 text-sm font-medium text-yellow-700 hover:text-yellow-800 focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:ring-offset-2 rounded transition-colors"
          >
            {action.label}
          </button>
      ...
      <ToastPrimitive.Close
        className="flex-shrink-0 text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:ring-offset-2 rounded transition-colors"
        aria-label="Close"
      >
        <svg
          width="15"
